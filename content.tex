...
Each release of the software is archived on the data repository Zenodo.
...
Containers allow us the capture the conditions of analysis in a formatted image that can be shared to others.
