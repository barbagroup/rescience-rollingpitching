...
Each significant release of the software is archived on the data repository Zenodo (e.g., version 0.5.1\supercite{mesnard_et_al_2020_zenodo_petibm}).
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.8\textwidth]{Re200_St0.6_AR1.27_psi90/meshgrid.png}
...
The build of a Docker image may not reproducible given just the recipe (Dockerfile).
